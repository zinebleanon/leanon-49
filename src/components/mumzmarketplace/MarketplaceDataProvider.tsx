...
// Import neighborhoods from the new UAE locations file
import { getAllNeighborhoods } from '@/data/uae-locations';
export const dubaiNeighborhoods = getAllNeighborhoods();
